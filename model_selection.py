...
class IIDAccuracySelectionMethod(SelectionMethod):
    ...
    def _step_acc(self, record):
        ...
        test_in_acc_key = 'env{}_in_acc'.format(test_env)
        # if 'env3' in test_in_acc_key and record[test_in_acc_key] == 0.7604590892262125:
        #     print([record[key] for key in val_env_keys])
        #     print(np.mean([record[key] for key in val_env_keys]))
        return {
